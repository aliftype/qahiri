...
التنویعات فی زی تطبیق یدعم خطوط أوبن تیب. للأسف تعانی كثیر من التطبیقات من ضعف
...
النقر على أی تنویعة سیستحدمها بدل الشكل الحالی للحرف:

![لقطة شاشة للتطبیق فی الوضع المبدئی](images/screenshot.png)
...
![لقطة شاشة للتطبیق بدون نقاط](images/screenshot-dotless.png)
...
![لقطة شاشة للتطبیق بنقاط مستدیرة](images/screenshot-rounded-dots.png)

یتیح التطبیق تصدیر ملف SVG للنص المكتوب یتیح تعدیله فی أی من تطبیقات الرسوم
